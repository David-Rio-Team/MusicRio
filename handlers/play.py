...
async def play(_, message: Message):
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        await message.reply_text(f"**{bn} :-** تم اضافة الاغنيه في قائمة الانتظار #{await callsmusic.queues.put(message.chat.id, file_path=file_path)} !")
    else:
